...
//Error
//fot_fmincon: Non Linear Constraint (9th Parameter) should be a function or an Empty Matrix
//at line     542 of function fot_fmincon called by :  
//fot_fmincon(f,x0,A,b,Aeq,beq,lb,ub,nlc,options)
//at line      40 of exec file called by :    
//exec fot_fmincon_nlc4.sce
