...
//Error
//fot_fmincon: Expected Row Vector (1 X number of Variables) for lower bound (7th Parameter) 
//at line     430 of function fot_fmincon called by :  
//[xopt,fopt,exitflag,output,lambda,gradient,hessian] = fot_fmincon (fun, x0, A, b, Aeq, beq, lb, ub);
//at line      24 of exec file called by :    
//exec fot_fmincon_lb2.sce
