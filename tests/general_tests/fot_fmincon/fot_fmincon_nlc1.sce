...
//Error
//fot_fmincon: Non-Linear Constraint function(9th Parameter) and x0(2nd Parameter) did not match
//at line     487 of function fot_fmincon called by :  
//fot_fmincon(f,x0,A,b,Aeq,beq,lb,ub,nlc,options)
//at line      44 of exec file called by :    
//exec fot_fmincon_nlc1.sce
