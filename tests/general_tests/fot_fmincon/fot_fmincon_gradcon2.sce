...
//Error
//fot_fmincon: Definition of (cg) in Non-Linear Constraint function(10th Parameter) should be in the form of (m X n) or Empty Matrix where m is number of Non- linear inequality constraints and n is number of Variables
//at line     647 of function fot_fmincon called by :  
//ncon(f,x0,A,b,Aeq,beq,lb,ub,nlc,options
//at line      44 of exec file called by :    
//exec fot_fmincon_gradcon2.sce
