...
//Error
//fot_fmincon: Wrong Input for Objective Hessian function(10th Parameter)---->Symmetric Matrix function is Expected 
//at line     630 of function fot_fmincon called by :  
//fot_fmincon(f,x0,A,b,Aeq,beq,lb,ub,nlc,options)
//at line      44 of exec file called by :    
//exec fot_fmincon_hess2.sce
