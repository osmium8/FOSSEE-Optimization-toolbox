...
//Error
//fot_fmincon: Size of Options (struct) should be even
//at line     558 of function fot_fmincon called by :  
//fot_fmincon(f,x0,A,b,Aeq,beq,lb,ub,nlc,options)
//at line      43 of exec file called by :    
//exec fot_fmincon_options1.sce
...
options=struct("MaxIter", [1500], "CpuTime", [500], "GradObj", fGrad, "Hessian", lHess,"GradCon");
