...
//Error
//fot_fmincon: Unrecognized parameter name GradientObj.
//at line     596 of function fot_fmincon called by :  
//fot_fmincon(f,x0,A,b,Aeq,beq,lb,ub,nlc,options)
//at line      44 of exec file called by :    
//exec fot_fmincon_options2.sce
...
options=struct("MaxIter", [1500], "CpuTime", [500], "GradientObj", fGrad, "Hessian", lHess,"GradCon",cGrad);
