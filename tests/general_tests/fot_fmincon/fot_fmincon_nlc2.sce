...
//Error
//fot_fmincon: Definition of c in Non-Linear Constraint function(9th Parameter) should be in the form of Row Vector or Empty Vector
//at line     493 of function fot_fmincon called by :  
//fot_fmincon(f,x0,A,b,Aeq,beq,lb,ub,nlc,options)
//at line      44 of exec file called by :    
//exec fot_fmincon_nlc2.sce
