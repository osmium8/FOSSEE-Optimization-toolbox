...
options = struct("MaxIter", [150], "CpuTime", [500], "GradCon", cGrad)
...
[xopt,fopt,exitflag,output,lambda,gradient,hessian] = fot_fmincon (fun, x0, A, b, Aeq, beq, lb, ub, nlc, options)
