...
//Error
//fot_fmincon: Wrong Input for Objective Gradient function(10th Parameter)---->Vector function is Expected
//at line     615 of function fot_fmincon called by :  
//fot_fmincon(f,x0,A,b,Aeq,beq,lb,ub,nlc,options)
//at line      44 of exec file called by :    
//exec fot_fmincon_grad2.sce
