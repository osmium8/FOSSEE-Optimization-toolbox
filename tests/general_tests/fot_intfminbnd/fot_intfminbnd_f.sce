...
//  !--error 10000 
// fot_intfminbnd: Expected type ["function"] for input argument fun at input #1, but got "constant" instead.
// at line      56 of function Checktype called by :  
// at line     141 of function fot_intfminbnd called by :  
// [xopt,fopt,exitflag,output,lambda] = fot_intfminbnd (fun, intcon, x1, x2, options);
// at line       7 of exec file called by :    
// exec fot_intfminbnd_f.sce
