...
//  !--error 10000 
// fot_intfminbnd_options: Expected type ["constant"] for input argument MaxIter at input #2, but got "string" instead.
// at line      56 of function Checktype called by :  
// at line     202 of function fot_intfminbnd called by :  
// [xopt,fopt,exitflag,output,lambda] = fot_intfminbnd (fun, intcon, x1, x2, options);
// at line       8 of exec file called by :    
// exec fot_intfminbnd_options1.sce
