...
intcon=[1,2]
//  !--error 10000 
// fot_intfminbnd: Expected type ["constant"] for input argument x2 at input #4, but got "list" instead.
// at line      56 of function Checktype called by :  
// at line     144 of function fot_intfminbnd called by :  
// [xopt,fopt,exitflag,output,lambda] = fot_intfminbnd(fun ,intcon, x1, x2, options)
// at line       8 of exec file called by :    
// exec fot_intfminbnd_ub2.sce
