...
[x,f,status,output] = fot_intlinprog(c,intcon,A,A,Aeq,beq,lb,ub)

// !--error 10000 
//fot_intlinprog: Constraint Upper Bound should be a vector
//at line     193 of function cbcmatrixfot_intlinprog called by :  
//at line     203 of function fot_intlinprog called by :  
//[x,f,status,output] = fot_intlinprog(c,intcon,A,A,Aeq,beq,lb,ub)
//at line      27 of exec file called by :    
//exec fot_intlinprog_b.sce
