...
// !--error 10000 
//fot_intlinprog: The values inside intcon should be less than the number of variables
//at line     111 of function cbcmatrixfot_intlinprog called by :  
//at line     203 of function fot_intlinprog called by :  
//[x,f,status,output] = fot_intlinprog(c,intcon,A,b,Aeq,beq,lb,ub)
//at line      27 of exec file called by :    
//exec fot_intlinprog_intcon2.sce
