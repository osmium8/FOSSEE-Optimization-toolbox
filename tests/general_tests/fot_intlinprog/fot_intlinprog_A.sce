...
[x,f,status,output] = fot_intlinprog(c,intcon,b,b,Aeq,beq,lb,ub)

// !--error 10000 
//fot_intlinprog: The size of inequality constraint is not equal to the number of variables
//at line     128 of function cbcmatrixfot_intlinprog called by :  
//at line     203 of function fot_intlinprog called by :  
//[x,f,status,output] = fot_intlinprog(c,intcon,b,b,Aeq,beq,lb,ub)
//at line      27 of exec file called by :    
//exec fot_intlinprog_A.sce
