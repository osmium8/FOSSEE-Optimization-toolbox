...
[x,f,status,output] = fot_intlinprog([],intcon,A,b,Aeq,beq,lb,ub)
//!--error 10000 
//fot_intlinprog: Cannot determine the number of variables because input objective coefficients is empty
//at line     172 of function fot_intlinprog called by :  
//[x,f,status,output] = fot_intlinprog([],intcon,A,b,Aeq,beq,lb,ub)
//at line      27 of exec file called by :    
//exec fot_intlinprog_emptyc.sce
