...
//Error
//fot_fminbnd: Lower Bound (2nd Parameter) cannot be empty
//at line     177 of function fot_fminbnd called by :  
//[xopt,fopt,exitflag,output,lambda] = fot_fminbnd (fun, lb, ub, options);
