...
//Calling fmincon
[xopt,fopt,exitflag,output,hessian] =fot_intfmincon(f, x0,intcon,A,b,Aeq,beq,lb,ub,nlc,options)

//  !--error 10000 
// fot_intfmincon: Expected type ["constant" or "function"] for input argument nlc at input #10, but got "string" instead.
// at line      56 of function Checktype called by :  
// at line     263 of function fot_intfmincon called by :  
// [xopt,fopt,exitflag,output,hessian] =fot_intfmincon(f, x0,intcon,A,b,Aeq,beq,lb,ub,nlc,options)
// at line      30 of exec file called by :    
// exec fot_intfmincon_logical10.sce
