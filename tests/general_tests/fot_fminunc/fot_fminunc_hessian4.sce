...
//Error
//fot_fminunc: Wrong Input for Objective Hessian function(3rd Parameter)---->Symmetric Matrix function of size [2 X 2] is Expected 
//at line     353 of function fot_fminunc called by :  
